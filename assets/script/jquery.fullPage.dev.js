...
(function(global, factory) {
    ...
    $.fn.fullpage = function(options) {
        ...
        */
        ...
        function init(){
            ...
            //FP.setAllowScrolling(true, 'up, down, left, right');
	...
	var swipe_flag = false
		...
		if (swipe_flag) {
			//$('.article-body').prepend('<div class="mask" style="width:100%; height: 100%;"></div>')
			//$('.article-body').prepend("<p class='debug'>swipe test:"+swipe_flag+" - " + event.isDefaultPrevented() +"</p>")
			//$('.debug').fadeOut(1000)
			if (event.isDefaultPrevented()) {
			//	removeTouchHandler()
		//		$(WRAPPER_SEL).unbind('touchmove')
			}
			swipe_flag = true
		//	return;
